...
Using the SMSGlobal Trunk, you can send SMS messages to your customers directly from the BGMconnects app, enabling use cases such as marketing campaigns and customer notifications.

This guide explains how to configure the SMSGlobal in the PBX to enable outbound SMS.
...
### Configure the SMSGlobal Trunk in the PBX
...
4. Enter the following values:
   * **Sender ID**
     ...
     * If left empty, the PBX will use the **DID number associated with the SMSGlobal trunk** as the Sender ID.
