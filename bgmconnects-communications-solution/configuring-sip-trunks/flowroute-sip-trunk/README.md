...
The PBX natively integrates with Flowroute SIP trunking to support voice calling and SMS/MMS messaging. Within the PBX configuration, users can select Flowroute as their service provider to fully utilize both calling and messaging services.

To successfully integrate Flowroute with the PBX, you must complete the following high-level steps:
...
3. **Configure Integration in the PBX**\
   Set up the Flowroute SIP trunk and messaging integration in the PBX Web Portal.
