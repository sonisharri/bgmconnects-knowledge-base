...
**DHCP Option 66** is a configuration option on a DHCP server that allows you to specify a **provisioning server URL** for devices. In the case of BGMconnects, Option 66 is set to the **provisioning root URL** of the PBX.
...
4. The phone uses this URL to download its configuration file from the **PBX**, based on its MAC address

<figure><img src="../../../.gitbook/assets/bgmconnects_dhcp66_phone.png" alt=""><figcaption></figcaption></figure>
...
> Refer to the article "[**DHCP Option 66 and Auto-Provisioning in BGMconnects**](auto-provisioning-security.md#dhcp-option-66-and-auto-provisioning-in-bgmconnects)**"** for details.

Each BGMconnects installation uses a **unique provisioning URL**. To obtain it:
...
```http
http://pbx.bgmconnects.com:8888/provision/R2Xu8aVV20Jka/
```

* `pbx.bgmconnects.com` – Your PBX FQDN
...
5. Paste the **BGMconnects provisioning root URL**
6. Click **OK**
7. Restart the **DHCP Server**

<figure><img src="../../../.gitbook/assets/bgmconnects_dhcp66_phone_1.png" alt="" width="141"><figcaption></figcaption></figure>

<figure><img src="../../../.gitbook/assets/bgmconnects_dhcp66_phone_2.png" alt=""><figcaption></figcaption></figure>
...
4. The phone downloads its configuration from the PBX
