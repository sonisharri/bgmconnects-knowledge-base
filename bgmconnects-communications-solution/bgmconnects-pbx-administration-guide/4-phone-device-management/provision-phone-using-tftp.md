...
3.  Set the TFTP root directory to the **PBX provisioning folder**.\
    ...
    > `R2Xu8aVV20Jka` is a **randomly generated provisioning folder name** created by the PBX.
...
<figure><img src="../../../.gitbook/assets/bgmconnects_tftp_phone.png" alt=""><figcaption></figcaption></figure>
