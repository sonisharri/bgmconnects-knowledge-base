...
With over 2 billion monthly users, WhatsApp stands as one of the most popular consumer messaging and communication platforms worldwide. This guide will walk you through the process of configuring your WhatsApp Business account on the PBX, enabling your extension users to communicate directly with customers via WhatsApp.

## **Prerequisites**

To integrate WhatsApp Business with the PBX, ensure the following requirements are met:
...
2. **Inbound Messaging Only**
   * WhatsApp integration with the PBX supports responding to inbound messages only.
...
3. **Full Chain SSL Certificates**
   *   To ensure successful webhook verification by the WhatsApp (Meta) platform, your PBX must be configured with a **trusted, full-chain SSL certificate**.
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects1.png" alt="" width="528"><figcaption></figcaption></figure>
...
3. **Configure the System User**
   * Set a name for the system user (e.g., `bgmconnects`).
   * Assign the **Admin** role to the user and click the **Create system user** button.

<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects2.png" alt="" width="330"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects22.png" alt=""><figcaption></figcaption></figure>

2. Navigate to **Users > System Users** from the left-hand menu and click **Generate New Token**.

<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects23.png" alt=""><figcaption></figcaption></figure>
...
3.  **Choose how long the token should remain valid.**\
    ...
    If the token expires, the PBX will no longer be able to send outbound WhatsApp messages. You will then need to generate a new token and update it in the PBX web portal before messaging can resume.
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects24.png" alt=""><figcaption></figcaption></figure>



5. Check the permissions for **whatsapp\_business\_messaging** and **whatsapp\_business\_management**.

<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects25.png" alt=""><figcaption></figcaption></figure>
...
To integrate the WhatsApp account you created with the PBX, follow these steps:

### **Add WhatsApp as a SIP Trunk**

1. Access the PBX web portal and log in as a **Tenant Manager**.
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects3.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects4.png" alt=""><figcaption></figcaption></figure>

## Configure Webhook in WhatsApp

To enable the PBX to receive inbound WhatsApp messages, follow these steps:

1. **Copy the Webhook URL**
   * Go to **Message Channels > WhatsApp** in the PBX Web portal.
   * Select the WhatsApp Channel and click the **Copy Webhook** button to copy the Webhook URL.

<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects5.png" alt=""><figcaption></figcaption></figure>
...
2. **Access the Meta Developer Portal**
   ...
   * Navigate to **WhatsApp > Configuration**, and paste the Webhook URL copied from the PBX.
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects6.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects7.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/whatsapp_bgmconnects8.png" alt=""><figcaption></figcaption></figure>
