...
Office Hours and Holiday Schedules are configured in the Web Portal by the tenant Admin. Once configured, they can be assigned to inbound rules used to route callers to specific destinations such as Virtual Receptionists (Auto Attendants), Call Queues, and users based on the time of the day, day of the week, or on selected holidays.
...
The PBX provides the following Office Hours and Holiday Schedule options:
...
1. Sign in to the PBX web portal as the tenant admin or as a user.
