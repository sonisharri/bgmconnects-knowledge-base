# Configuring Virtual Receptionist

The virtual receptionist feature allows the PBX to answer phone calls automatically. When a call comes into the PBX, the caller is presented with a list of options. The caller can choose the appropriate option by using the numbers on their phone keypad. You can implement a menu by using this feature. A virtual receptionist is also known as an **Auto Attendant**.
