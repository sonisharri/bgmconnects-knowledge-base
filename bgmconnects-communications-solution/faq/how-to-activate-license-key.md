...
The license key you purchased from BGMconnects is shared between the PBX and SBC. Once you receive the key from BGMconnects, follow these steps to activate it.

## **Activating the License Key for the PBX**
...
## **Activating the License Key for the SBC**

1. Sign in to the SBC Web portal as the Administrator.
