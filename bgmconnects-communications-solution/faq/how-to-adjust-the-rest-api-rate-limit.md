# How to Adjust the REST API Rate Limit? (RESERVED)
...
1. Open the file `var/lib/bgmconnects/pbx/system.ini`. For Windows, this file is located at `C:/ProgramData/PortSIP/pbx/system.ini`.
...
```
cd /opt/bgmconnects && /bin/sh pbx_ctl.sh restart -s bgmconnects.gateway
```
