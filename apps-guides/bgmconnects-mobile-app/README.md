...
You can also download the latest versions of BGMconnects from the [BGMconnects website](https://www.bgmconnects.com/downloads/), which provides links for supported platforms.
-->
